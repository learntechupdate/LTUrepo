...
import pageobject2.TripAdvisorHotelUserReviewPage;
...
//		js.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath("//div[@id='REVIEWS']")));
		GenericUtility.scrollTillWebelement(driver, trhp.reviewstabWebelement());
...
//		driver.switchTo().window(windowHandles2.get(2));
		GenericUtility.swToTab(driver, 3);
...
//		  driver.findElement(By.xpath("//input[@id='noFraud']")).click();
		 GenericUtility.scrollTillWebelement(driver, urp.submitReviewSectionWebelement());
